...
\newcommand{\article}[1]{\setcounter{sectionNumber}{0}\stepcounter{articleNumber}{\Large\textbf{{\\Article \Roman{articleNumber}: #1}}}}
% Create a new section, have good spacing between sections, and have them align to the left
\newcommand{\sect}[0]{\stepcounter{sectionNumber}\bigskip{\raggedright{\Large Section \Roman{sectionNumber}. }}}
...
UPE will work toward its goal by holding events, including an innual induction ceremony and inviting guest speakers to discuss ethics in computer science.
...
\begin{enumerate}[(a)]
    \item Chief Organization Officer (COO). Spokesperson of the group that regularly interacts with other student organizations and University officals.
